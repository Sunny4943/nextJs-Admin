...
const CompactCell = props => <Cell {...props} style={{ padding: 3, fontWeight: 'bold', }} />;
class Dashboard extends React.Component {
    ...
    onModalClick = (modalType, modalName, value, strategyName) => {
        if (modalType === "openModal") {
            if (modalName === "COMPLETED") {
                this.props.completedRowClick(value);
                console.log(strategyName)
                // this.props.openModal(modalName, value);// for strategyCOde
                this.props.openModal(modalName, strategyName);
    ...
    render() {
        const completedData = this.props.state.completedList.filter((v, i) => {
        ...
        const completedRowData = this.props.state.completedListRowArray.filter((v, i) => {
                ...
                <div style={{ width: "100%" }}>
                    <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: 'auto', }}>
                        ...
                        <div style={{ padding: '10px', paddingTop: '1px', width: '100%' }}>
                            <div>
                                <Table height={200} data={completedData} style={{ cursor: "pointer" }} hover={true} virtualized
                                    //onRowClick={(rowData) => { this.onModalClick("openModal", "PENDING", rowData.StrategyCode) }}
                                ...
                                >
                                    {/*<Column width={this.props.state.width > 600 ? 'auto' : 90} flexGrow={this.props.state.width > 600 ? 1 : 0} resizable>
                                        <HeaderCell wordWrap='keep-all' style={{ background: "#1e90ff", color: "#ffffff", fontWeight: 'bold', fontSize: 18 }}>Client Id</HeaderCell>
                                        <Cell dataKey="ClientID" style={{ color: "#333", fontWeight: 'bold', fontSize: 18, }} />
                                </Column>*/}
                                    ...
                                    <Column width={this.props.state.width > 600 ? 'auto' : 200} flexGrow={this.props.state.width > 600 ? 1 : 0} resizable >
                                        ...
                                        <Cell align="left" style={{ color: "#333", fontWeight: 'bold' }}>
                                            {rowData =>
                                                <span onClick={() => { this.onModalClick("openModal", "PENDING", rowData.StrategyCode, rowData.StrategyName) }} style={{ width: "100%", height: '100%' }}>{rowData.StrategyCode}</span>
                                            }
                                        </Cell>
                                    </Column>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: 'auto', }}>
                        ...
                        <div style={{ padding: '10px', paddingTop: '1px', width: 'auto' }}>
                            <div>
                                ...
                                }} onRowClick={(rowData) => { this.onModalClick("openModal", "COMPLETED", rowData.StrategyCode, rowData.StrategyName) }} bordered cellBordered rowHeight={38}>
                                    {/* <Column width={this.props.state.width > 600 ? 'auto' : 90} flexGrow={this.props.state.width > 600 ? 1 : 0} resizable>
                                        <HeaderCell style={{ background: "#1e90ff", color: "#ffffff", fontWeight: 'bold', fontSize: 18 }}>Client Id</HeaderCell>
                                        <Cell dataKey="ClientID" style={{ color: "#333", fontWeight: 'bold', fontSize: 18 }} />
                            </Column>*/}

                                    <Column width={this.props.state.width > 600 ? 'auto' : 200} flexGrow={this.props.state.width > 600 ? 1 : 0} resizable>
                                        <HeaderCell style={{ background: "#1e90ff", color: "#ffffff", fontWeight: 'bold', fontSize: 15 }}>Strategy Name</HeaderCell>
                                        <Cell style={{ color: "#333", fontWeight: 'bold', }}>
                                            {rowData =>
                                                <span >{rowData.StrategyName} ({rowData.StrategyCode})</span>
                                            }</Cell>
                                    </Column>
                                ...
                                <Modal.Body style={{ padding: '0px', margin: "0px", width: "100%", height: "100%" }}>
                                    <div style={{ width: "auto", height: "auto" }}>
                                        <Table width='auto' height={480} data={completedRowData}
                                            ...
                                            <Column width={210} resizable fullText>
